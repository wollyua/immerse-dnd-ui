...
import CharactersListPage from "./modules/CharactersListPage.tsx";
...
const userId: string = "225968fb-ede1-42fd-87eb-7640bd2d5a45";
//const characterId: string = "ed8e9b93-ee56-4854-a446-dc2bac1ec62b";

const router = createBrowserRouter([
  { path: "/", element: <HomePage /> },
  {
    path: "/my-characters",
    element: <CharactersListPage userId={userId} />,
  },
  {
    path: "/my-characters/:characterId",
